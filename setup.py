...
def get_version():
    main_file = os.path.join(CURDIR, "src/redistools", "__init__.py")
...
setup(
    ...
    url='https://github.com/radiocut/redis-tools/',  # Optional
    ...
    project_urls={  # Optional
        'Bug Reports': 'https://github.com/radiocutfm/redis-tools/issues',
        'Funding': 'https://donate.pypi.org',
        'Say Thanks!': 'https://saythanks.io/to/guillermo.narvaja%40radiocut.fm',
        'Source': 'https://github.com/radiocutfm/redis-tools/',
    },
)
